                ...
                <div>
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="First Name" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>
                        <div>
                            <label className="block mb-1 font-medium">Last Name*</label>
                            <input type="text" placeholder="Last Name" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>

                        {/* Row 2 */}
                        <div>
                            <label className="block mb-1 font-medium">Country / Region*</label>
                            <input type="text" placeholder="Country / Region" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>
                        <div>
                            <label className="block mb-1 font-medium">Company Name</label>
                            <input type="text" placeholder="Company (optional)" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>

                        {/* Row 3 */}
                        <div>
                            <label className="block mb-1 font-medium">Street Address*</label>
                            <input type="text" placeholder="House number and street name" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>
                        <div>
                            <label className="block mb-1 font-medium">Apt, suite, unit</label>
                            <input type="text" placeholder="apartment, suite, unit, etc. (optional)" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>
                        ...
                        <div className="grid grid-cols-3 col-span-2 gap-x-4">
                            <div>
                                ...
                                <input type="text" placeholder="Town / City" className="w-full border rounded px-4 py-2 bg-gray-100" />
                            </div>
                            <div>
                                <label className="block mb-1 font-medium">State*</label>
                                <select className="w-full border rounded px-4 py-2 bg-gray-100">
                                    <option>State</option>
                                </select>
                            </div>
                            <div>
                                <label className="block mb-1 font-medium">Postal Code*</label>
                                <input type="text" placeholder="Postal Code" className="w-full border rounded px-4 py-2 bg-gray-100" />
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <input type="text" placeholder="Phone" className="w-full border rounded px-4 py-2 bg-gray-100" />
                        </div>
                    </form>
                    <button type='submit'
                    ...
                    <div className='overflow-y-auto flex-1'>
                        {cartItems.map((item, index) => (
                            <div key={index} className='grid grid-cols-[1fr_2fr_1fr] p-4 border-t border-t-gray-400 gap-2 items-center'>
                                <div className='h-15 border rounded'></div>
                                <div>
                                    <h1>{item.details.pName} * {item.quantity}</h1>
                                    <h1 className='font-bold'>Color: <span>{item.details.color}</span></h1>
                                </div>
                                <h1>{item.price}</h1>
                            </div>
                        ))}
